...
for (year in c(2021, 2022, 2023, 2024)) {
  ...
  if (year == 2021) {
...
} # comment this } out to run the entire script as a loop
    ...
    control_individuals_merged  %>% 
      write_csv(paste0(admin_out, "control_individuals_merged_non_normalized.csv"))
